...
var menuService = /** @class */ (function () {
    function menuService(menu_model) {
        if (menu_model === void 0) { menu_model = new menu_model_1.menuModel(); }
        this.menu_model = menu_model;
    }
    menuService.prototype.createmenu = function (create) {
        return __awaiter(this, void 0, void 0, function () {
            var menus;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        menus = new menu_entity_1.menu() //檢
                        ;
                        ...
                        return [4 /*yield*/, this.menu_model.create(menus)];
                    case 1:
                        _a.sent();
    ...
    menuService.prototype.getmenus = function (read) {
        return __awaiter(this, void 0, void 0, function () {
            var menus;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.menu_model.find({})];
                    case 1:
                        menus = _a.sent();
                        return [2 /*return*/, { data: menus }];
                }
            });
        });
    };
    menuService.prototype.Putmenus = function (Put) {
        return __awaiter(this, void 0, void 0, function () {
            var menus;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.menu_model.findOne({ where: { Id: Put.menu_Id } })];
                    case 1:
                        menus = _a.sent();
                        menus.menu_type = Put.menu_type;
                        menus.menu_price = Put.menu_price;
                        menus.menu_rating = Put.menu_rating;
                        return [4 /*yield*/, this.menu_model.save(menus)];
                    case 2:
                        _a.sent();
    ...
    menuService.prototype.Deletemenus = function (Delete) {
        return __awaiter(this, void 0, void 0, function () {
            var menus;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.menu_model.findOne({ where: { Id: Delete } })];
                    case 1:
                        menus = _a.sent();
                        if (!menus)
                            throw new error_middleware_1.InvalidInputError("No id found");
                        return [4 /*yield*/, this.menu_model.delete(menus)];
                    case 2:
                        _a.sent();
